...
WEBHOOK_BASE = os.environ.get("WEBHOOK_BASE", "https://repository-gayga-ugu-horee-yay-673r.onrender.com")
            ...
            if audio_path:
                ...
                try:
                    try:
                        ...
                        bot_username = None
                    performer = f"Powered by @{bot_username}" if bot_username else "Powered by Bot"
